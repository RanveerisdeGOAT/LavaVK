...
namespace LavaVK {
    ...
    public:
         ...
         * @param format Preferred color format (e.g., VK_FORMAT_B8G8R8A8_SRGB).
    ...
    private:
        ...
        VkFormat m_format = VK_FORMAT_UNDEFINED;     ///< Swapchain color format.
        VkExtent2D m_extent{};                       ///< Dimensions of swapchain images.

        std::vector<Image> m_images;                 ///< Wrappers around swapchain VkImage handles.
