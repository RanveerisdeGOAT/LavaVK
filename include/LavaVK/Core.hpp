...
namespace LavaVK {
    ...
    enum class ResultCode {
        ...
        /**< A swapchain is incompatible with the surface and must be recreated. */
    ...
    enum class AccessFlagBits {
        ...
        COMMAND_PREPROCESS_READ_BIT_EXT = VK_ACCESS_COMMAND_PREPROCESS_READ_BIT_EXT,
        ...
        FLAG_BITS_MAX_ENUM = VK_ACCESS_FLAG_BITS_MAX_ENUM
    };

    inline AccessFlagBits operator|(AccessFlagBits lhs, AccessFlagBits rhs) {
        return static_cast<AccessFlagBits>(static_cast<uint32_t>(lhs) | static_cast<uint32_t>(rhs));
    }
}
